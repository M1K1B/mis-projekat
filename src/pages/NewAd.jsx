  ...
  return (
    <div className="rounded bg-white p-4 w-50 mx-auto mt-4">
      <div className="d-flex justify-content-between align-items-center">
        <h4 class="m-0">Novi oglas</h4>
        <Link className="btn btn-danger" to={"/ads"}>
          <BsArrow90DegLeft className="mb-1 me-1" /> Nazad
        </Link>
      </div>
      <hr class="mb-4" />
      <div class="mb-3 row">
        ...
        <div className="col">
          <div className="col">
            ...
            >
              <option value={AdType.Person}>Nudim čuvanje</option>
              <option value={AdType.Dog}>Tražim čuvara za psa</option>
              <option value={AdType.Cat}>Tražim čuvara za mačku</option>
              <option value={AdType.Parrot}>Tražim čuvara za papagaja</option>
            </select>
          </div>
        </div>
      </div>
      <div class="form-floating">
        <textarea
          ...
          placeholder="Opis oglasa (max. 200 karaktera)"
